						...
						<div class="form-holder">
							<div class="form-content">
								<div>
									...
									<form action="${pageContext.request.contextPath}/adminSaveAndUpdateGairAarthikSahyog" 
									method="POST" enctype="multipart/form-data">

										<div class="col-md-12">
										<input class="form-control" type="hidden" name="id"
												placeholder="Full Name" required id="idE">
...
<textarea class="form-control"  name="sahyogDetail" rows="4" cols="50" 
placeholder="Describe yourself here..." id="detailsE">
...
<div class="text-center">
	<button onclick="addGairAarthik()">Add

...
<div class="d-flex justify-content-center"><h3 style="color: blue;" >-:गैर आर्थिक सहयोग:-</h3></div>
...
<%@include file="../components/adminAddGairAarthik.jsp"%> 

		<%@include file="../components/adminGairAarthikSahyog.jsp"%> 

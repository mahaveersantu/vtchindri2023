 ...
 <section id="topbar" class="d-flex align-items-center">
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="${pageContext.request.contextPath}/">चिन्दड़ी श्री वीर तेजाजी मंदिर ट्रस्ट जोधपुर (राज)<span>.</span></a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="logo"><img src="assets/img/logo.png" alt=""></a>-->

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="${pageContext.request.contextPath}/">होम</a></li>
          ...
          <li class="dropdown"><a href="#"><span>सहयोग</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="${pageContext.request.contextPath}/showAarthikSahyog">आर्थिक सहयोग</a></li>
